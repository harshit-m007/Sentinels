...
class IMTFE(nn.Module):
    ...
    def __init__(self, in_channel=3,device=device):
        ...
        self.SRMConv2D.weight.data=torch.load(r'C:\Users\prasu\Desktop\sentinels\Sentinels\team_sentinels\backend\model\IMTFEv4.pt')['SRMConv2D.weight']
...
def pre_trained_model(weight_path=r'D:\Sentinels\team_sentinels\backend\model\MantraNetv4.pt',device=device):
...
# def check_forgery(model, img_path='./example.jpg', device=device, output_dir='ManTraNet-pytorch/MantraNet/Output/'):
